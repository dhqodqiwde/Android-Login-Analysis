...
// output file
const (
	output_path                       = "../Raw Dataset(Selection Process)/github_issues.txt"
	words_count_file_path             = "../Raw Dataset(Selection Process)/words_count.txt"
	TF_IDF_path                       = "../Raw Dataset(Selection Process)/TF_IDF.txt"
	searched_repos_path               = "../Raw Dataset(Selection Process)/searched_repos.txt"
	repos_cantain_aimed_packages_path = "../Raw Dataset(Selection Process)/repos_cantain_aimed_packages.txt"
	repos_with_new_dependencies_path  = "../Raw Dataset(Selection Process)/repos_with_new_dependencies.txt"
	all_new_dependencies_path         = "../Raw Dataset(Selection Process)/all_new_dependencies.txt"
)
